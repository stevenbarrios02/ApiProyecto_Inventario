...
namespace ApiProyecto.Migrations
{
    ...
    [Migration("20251031145757_FinalizarRefreshTokenSetup")]
    partial class FinalizarRefreshTokenSetup
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApiProyecto.Models.MovimientoInventario", b =>
                {
                    b.Property<int>("IdMovimientoInventario")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("idMovimientoInventario");

                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("IdMovimientoInventario"));
            ...
            modelBuilder.Entity("ApiProyecto.Models.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApiProyecto.Models.Producto", b =>
                {
                    b.HasOne("ApiProyecto.Models.Inventario", "Inventario")
                        .WithMany("Productos")
            ...
            modelBuilder.Entity("ApiProyecto.Models.Usuario", b =>
                {
                    b.HasOne("ApiProyecto.Models.Persona", "Persona")
                        .WithOne("Usuario")
                        .HasForeignKey("ApiProyecto.Models.Usuario", "PersonasIdPersonas")
